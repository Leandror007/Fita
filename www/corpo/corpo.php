...
<?php  if($_SESSION['nivel'] == 'Sup') { ?>
          ...
          <li class="treeview">
              <a href="#">
                <i class="fa fa-bars"></i> <span>Registro</span>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
               <li><a href="../grafico/index.php"><i class="fa fa-circle-o"></i> Grafico OG</a></li>
              </ul>
            </li>

            <li class="treeview">
              <a href="#">
                <i class="fa fa-cloud-upload"></i> <span>Baixar / Enviar</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                 <li><a href="../baixarTabela/index.php"><i class="fa fa-circle-o"></i> Baixar</a></li>
           ...
           <li class="treeview">
              <a href="#">
                <i class="fa fa-exchange"></i> <span>Passagens</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
